...
const LoginSignup = (props) => {
  ...
  const [sres, setsres] = useState({ rsid: "", rMname: "" })
  const [tlog, settlog] = useState({ tlemailorId: "", tlpassword: "" })
  const [tsign, settsign] = useState({ tsid: "", tsname: "", tsemail: "", tspassword: "", cpassword: "" })
